...
class CoTDeduper:
    ...
    def _load_encoder(self):
        ...
        # using sentence-transformers as a drop-in placeholder for now
    ...
    def dedup(self, steps: list[str]) -> list[str]:
        ...
        Args:
            steps: Ordered list of reasoning step strings from the model.

        Returns:
            Deduplicated list preserving original order and first occurrence.
